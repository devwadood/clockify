...
export async function sendEmail(message: EmailMessage) {
  ...
  const result = await resend.emails.send({
    from: process.env.EMAIL_FROM ?? "Tracker <noreply@tracker.abdulwadood.com>",
    ...message,
  });
